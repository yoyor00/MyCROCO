...
!
!===================================================================================================
!  subroutine Agrif_KNHINT
!---------------------------------------------------------------------------------------------------
subroutine Agrif_KNHINT ( tcoef )
!---------------------------------------------------------------------------------------------------
integer :: tcoef
    Agrif_Curgrid % KNHINT_tcoef = tcoef
!---------------------------------------------------------------------------------------------------
end subroutine Agrif_KNHINT
!===================================================================================================
!  subroutine Agrif_KNHINT_tcoef
!---------------------------------------------------------------------------------------------------
function Agrif_KNHINT_tcoef ( )
!---------------------------------------------------------------------------------------------------
    integer :: Agrif_KNHINT_tcoef ! result
!
    Agrif_KNHINT_tcoef= Agrif_Curgrid % KNHINT_tcoef
!---------------------------------------------------------------------------------------------------
end function Agrif_KNHINT_tcoef
!===================================================================================================
