...
# endif
                      ...
                      /* BLOOM biology model with BIOLink coupling */
/* Partie liée à BIOLink, ajoutée par G. Koenig (17/11/2021) */
/* interface/coupler BIOLink */
# define BIOLink
# if defined BIOLink
#  define BIOLink_UPDATE_CONCBIO
#  define BIOLink_PAR_eval
#  undef key_BIOLink_verif_conserv
#  undef key_nosubstmodule
# endif
/* Et la sous-partie dédié à BLOOM
Ajoutée par G. Koenig (17/11/2021) */
# define BLOOM
# if defined BLOOM
#  define key_oxygen
...
/*   if define key_BLOOM_insed, you must have also define key_oxygen*/
#    define key_oxygen
#   else
#    undef key_BLOOM_insed
#   endif
#   undef key_physadaptation
#   undef key_zostera
#   undef key_benthos
#   undef key_diatbenth
#   undef key_NPbenth
#   undef key_karenia
#   undef key_psnz
#   undef key_phaeocystis
#   undef key_oyster_SFG
#   undef key_oyster_DEB
#   undef key_oyster_benthos
#   undef key_messat
#   undef key_turblim
#   undef key_daily_climato_kpar
#   undef key_N_tracer
#   undef key_P_tracer
#   undef key_age_tracer
#  endif
# endif
#
                      /*   MUSTANG Sediment model     */
