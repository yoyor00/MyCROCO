...
# ---------------------
TOOLS_DIR=${PWD}/../croco_tools_dev

# Configuration name
# ------------------
MY_CONFIG_NAME=RUN_V2.0_cforec_LR_DEV

# Home and Work configuration directories
# ---------------------------------------
# MY_CONFIG_HOME=${CROCO_DIR}
# MY_CONFIG_WORK=${CROCO_DIR}
MY_CONFIG_HOME=/local/tmp/3/gcambon/CONFIGS
MY_CONFIG_WORK=/local/tmp/3/gcambon/CONFIGS
