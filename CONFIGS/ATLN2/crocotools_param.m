...
%
CROCO_title  = 'Atlantique Nord Est Boutet';
CROCO_config = 'ANE_Boutet';
%
% Grid dimensions: page 70
%
lonmin =  -9;   % Minimum longitude [degree east]
lonmax =  1; % Maximum longitude [degree east]
latmin = 43;   % Minimum latitudeF  [degree north]
latmax = 51;   % Maximum latitude  [degree north]
%
