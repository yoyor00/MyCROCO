...
20    CONTINUE
   ...
   FUNCTION selec_dome_or_asymp(l, alpha1, beta1)
      ...
      !&E
      !&E ** Called by      : ibm_3d, death_by_fishing
      !&E ** External calls :
      !&E
      !&E ** History :
      !&E       !  2023   (C. Menu)
   ...
   SUBROUTINE death_by_fishing(particle, species, year, month, dtm)
      ...
      !&E **
      !&E ** Called by      : ibm_3d
      !&E ** External calls : selec_dome_or_asymp
      ...
      END IF   ! fishing_strategy == F_eval
