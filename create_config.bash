...
allmodels_incroco_dev=( oce-dev xios test_cases agrif inter forc stogen pisces sediment mustang oanalysis mattools pytools ms3dvar )
allmodels_incroco_prod=( oce-prod xios test_cases agrif inter forc stogen pisces sediment mustang oanalysis mattools pytools ms3dvar )
allmodels_cpl=( oce-prod xios test_cases agrif runcpl stogen pisces sediment mustang oanalysis mattools pytools cpl wav atm toy ms3dvar )
