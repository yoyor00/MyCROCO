...
#  undef UV_VIS_SMAGO
# endif
                     /* Semi-imp Vertical Tra/Mom Advection */
# undef  VADV_ADAPT_IMP
                     /* Advective Schemes */
# define SUPERBEE 
# define UV_HADV_TVD
...
# undef  T_FRC_BRY
# undef  ANA_INITIAL
# define ANA_SSH        /* <-- needed for z forcing init to 0 */
# define ANA_M2CLIMA    /* <-- needed for ext forcing init to 0  */
...
#   undef UV_VIS_SMAGO
# endif
                    /* Semi-impl Vert Tra/Mom Advection */
# undef  VADV_ADAPT_IMP
