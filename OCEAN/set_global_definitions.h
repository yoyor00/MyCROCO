...
#  ifdef MPI
#   define GLOBAL_2D_ARRAY -2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Lm+3+padd_X+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS,-2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Mm+3+padd_E+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#   define GLOBAL_1D_ARRAYXI -2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Lm+3+padd_X+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#   define GLOBAL_1D_ARRAYETA -2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Mm+3+padd_E+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#   define START_2D_ARRAY -2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS,-2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#   define START_1D_ARRAYXI -2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#   define START_1D_ARRAYETA -2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#  else
#   ifdef EW_PERIODIC
#    define GLOBAL_1D_ARRAYXI -2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Lm+3+padd_X+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#    define START_1D_ARRAYXI -2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
...
#     define START_1D_ARRAYETA -2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#    else
#     define GLOBAL_2D_ARRAY -2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Lm+3+padd_X+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS,0:Mm+1+padd_E
#     define START_2D_ARRAY -2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS,0
...
#    ifdef NS_PERIODIC
#     define GLOBAL_2D_ARRAY 0:Lm+1+padd_X,-2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Mm+3+padd_E+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#     define GLOBAL_1D_ARRAYETA -2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Mm+3+padd_E+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#     define START_2D_ARRAY 0,-2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#     define START_1D_ARRAYETA -2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#    else
...
# else
#  ifdef MPI
#   define GLOBAL_2D_ARRAY -1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Lm+2+padd_X+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS,-1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Mm+2+padd_E+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#   define GLOBAL_1D_ARRAYXI -1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Lm+2+padd_X+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#   define GLOBAL_1D_ARRAYETA -1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Mm+2+padd_E+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#   define START_2D_ARRAY -1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS,-1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#   define START_1D_ARRAYXI -1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#   define START_1D_ARRAYETA -1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#  else
#   ifdef EW_PERIODIC
#    define GLOBAL_1D_ARRAYXI -1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Lm+2+padd_X+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#    define START_1D_ARRAYXI -1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
...
#     define START_1D_ARRAYETA -1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#    else
#     define GLOBAL_2D_ARRAY -1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Lm+2+padd_X+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS,0:Mm+1+padd_E
#     define GLOBAL_1D_ARRAYETA 0:Mm+1+padd_E
#     define START_2D_ARRAY -1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS,0
#     define START_1D_ARRAYETA 0
#    endif
#   else
#    define GLOBAL_1D_ARRAYXI 0:Lm+1+padd_X+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#    define START_1D_ARRAYXI 0
#    ifdef NS_PERIODIC
#     define GLOBAL_2D_ARRAY 0:Lm+1+padd_X,-1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Mm+2+padd_E+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#     define GLOBAL_1D_ARRAYETA -1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Mm+2+padd_E+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#     define START_2D_ARRAY 0,-1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#     define START_1D_ARRAYETA -1-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
#    else
#     define GLOBAL_2D_ARRAY 0:Lm+1+padd_X,0:Mm+1+padd_E
#     define GLOBAL_1D_ARRAYETA 0:Mm+1+padd_E
...
# define PRIVATE_1D_SCRATCH_ARRAY Istr-2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Iend+2+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
# define PRIVATE_2D_SCRATCH_ARRAY Istr-2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Iend+2+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS,Jstr-2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Jend+2+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
# define PRIVATE_1DXI_SCRATCH_ARRAY Istr-2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Iend+2+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS
# define PRIVATE_1DETA_SCRATCH_ARRAY Jstr-2-MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS:Jend+2+MPI_OVERLAPPING_SCHWARZ_2D_NUM_LAYERS

#else /* MPI_OVERLAPPING_SCHWARZ_2D */
...
#endif /* MPI_OVERLAPPING_SCHWARZ_2D */
/*
