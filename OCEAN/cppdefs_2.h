...
# define NBQ2
# define M3FAST_HIS
# if defined NBQ2 || defined HCOMP || defined  NHINT || defined H3D
#  undef NBQ_PRECISE
#  undef NBQ_GRAV
#  undef NBQ_GRAV3
#  undef NBQ_GRAV4
#  undef M3FAST_DISSCOUPLING
# endif
