...
#  endif
   ...
   character(len=180) :: ablname = "CROCO_FILES/croco_abl_his.nc"
...
#  ifdef AVERAGES
   ...
   character(len=180) :: ablname_avg = "CROCO_FILES/croco_abl_avg.nc"
...
#ifdef BLOOM
   ! &croco_bloom
   character(len=180) :: bloomfilename = "paraBLOOM.txt"
   !! Bloom module parameters input file
#  ifdef DIAGNOSTICS_BIO
   ! &croco_bloom_diag
   character(len=180) :: bloomdiagfilename = "paradiagBLOOM.txt"
   !! Bloom module diagnostics definition parameters input file
#  endif
#endif
...
# endif
   ...
   ! &croco_BIOLink_par_history_fields
   logical :: out_his_Biolinkpar = .true.
   !! Flag (T/F) to write PAR (photosynthetically active radiation) in history file
#endif
