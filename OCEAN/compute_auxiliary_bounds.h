...
#  define MPI_OVERLAPPING_SCHWARZ_2D_ADD_LAYERS_AUX (MPI_OVERLAPPING_SCHWARZ_2D_ADD_LAYERS-MPI_OVERLAPPING_SCHWARZ_2D_TS_HALO_REDUCTION*lat_hid_2d_subtimestep)
# else
#  define MPI_OVERLAPPING_SCHWARZ_2D_ADD_LAYERS_AUX MPI_OVERLAPPING_SCHWARZ_2D_ADD_LAYERS
# endif
...
#  ifdef EW_PERIODIC
      Istr = Istr - MPI_OVERLAPPING_SCHWARZ_2D_ADD_LAYERS_AUX
      Iend = Iend + MPI_OVERLAPPING_SCHWARZ_2D_ADD_LAYERS_AUX
#  else
...
#  ifdef NS_PERIODIC
      Jstr = Jstr - MPI_OVERLAPPING_SCHWARZ_2D_ADD_LAYERS_AUX
      Jend = Jend + MPI_OVERLAPPING_SCHWARZ_2D_ADD_LAYERS_AUX
#  else
