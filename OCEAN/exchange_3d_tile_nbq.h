#ifndef MP_3PTS
      subroutine exchange_3d_tile_nbq (iv,Istr,Iend,Jstr,Jend, A)
#else
      subroutine exchange_3d_3pts_tile_nbq (iv,Istr,Iend,Jstr,Jend, A)
#endif
!
...
# endif
      ...
      k=N-KSTART+1
# ifndef MP_3PTS
      call MessPass3D_tile_nbq (iv,Istr,Iend,Jstr,Jend,  A,k)
# else
      call MessPass3D_3pts_tile_nbq (iv,Istr,Iend,Jstr,Jend,  A,k)
# endif
#endif
      return
      end
...
# ifndef MP_3PTS
#  define MP_3PTS
#  include "exchange_3d_tile_nbq.h"
#  undef MP_3PTS
# endif
