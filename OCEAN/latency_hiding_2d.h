...
# ifndef MPI_OVERLAPPING_SCHWARZ_2D_ADD_LAYERS
#  error "MPI_OVERLAPPING_SCHWARZ_2D_ADD_LAYERS not defined, but MPI_OVERLAPPING_SCHWARZ_2D activated"
# endif

# ifndef MPI_OVERLAPPING_SCHWARZ_2D_COMM_N_TIMES
#  define MPI_OVERLAPPING_SCHWARZ_2D_COMM_N_TIMES (MPI_OVERLAPPING_SCHWARZ_2D_ADD_LAYERS)
#  error "MPI_OVERLAPPING_SCHWARZ_2D_COMM_N_TIMES not defined, but MPI_OVERLAPPING_SCHWARZ_2D activated"
# endif

#else

# define MPI_OVERLAPPING_SCHWARZ_2D_ADD_LAYERS 0
