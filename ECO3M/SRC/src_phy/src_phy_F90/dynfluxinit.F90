...
!     barrier.n --- modified barrier.n
!     994 changed to 94 in the next few lines
...
!     Initialisation rappel colonne T et S   
      rewind(95)
 101  continue
