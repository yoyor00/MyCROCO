...
!***********************************************************************
       subroutine RUNDEF
!
! Appele par main.f: lecture de runparam.i et initalisation des variables
!    du run - lecture de la grille verticale.
!
! ======================================================================
!
! -------------------------------------
! Definition de la configuration du run.
! -------------------------------------
!
       Use comrunmod
       Use comdynmod
...
! Definition des directories de travail et des racines des fichiers out
       do jl=120,1,-1
...
! MB     &    cnmlog(1:nmlog)//'/'//cdir(ndir0:ndir)//'_'

! MB       nroot=nmlog+1+(ndir-ndir0+1)+1
       nroot=nmlog+1+(ndir-ndir0+1)

! Definition de parametres temporels
       dts=dt*hourm
...
! Verification de la coherence des entreees et des dimensions
...
! Ecriture de la definition du RUN
       call WRUNPRINT
