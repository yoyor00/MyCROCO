...
! Angle solaire du soleil en deg.
...
! Angle zenithal en deg,
       azsun=90.-hsun

! Discretisation de l'angle zenithal (1-19)
       jaz1=1+int(azsun/5.)
...
! Calcul de PAR0+ et PAR0- en ciel clair
       xpar0p=0.
       xpar0m=0.       
       do jl=1,nzt,nfrog
         zfcl=1.
...
! Prise en compte de la nebulosite
!      ztrsw=1.-0.38*xneb-0.38*xneb*xneb
       zw0p043=xpar0p/0.43
