...
C
       ...
       Use comdynmod
C
C       if (mflagrun.eq.1) then
C         write(99,1001) nbrbio,nbrprono
C         print*, ' ==================='
C         print*, ' STOP : mflagrun = 1'
C         print*, ' ==================='
C         stop
C       endif
C 1001  format(/,2x,'Nbr de variables biogeochimiques = ',i3,
C     &   'avec  nbr de variables pronostiques = ',i3)
C
