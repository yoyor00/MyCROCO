...
C
C ----------------------------------------------------------------
C Moyenne, sauvegarde et initialisation sur nundynfl des tendances
C ----------------------------------------------------------------
C Traceurs dynamiques
C
C
C Longueur melange, Brunt Vaissaila, Cisaillement
C
       do jk=1,nzt
...
C
       ...
       enddo
C
C Tendances equation Temperature
C
       do jk=1,nzt
