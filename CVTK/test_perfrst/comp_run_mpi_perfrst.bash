...
$MPIRUN --allow-run-as-root -np $NBPROCS ./croco_${par1}.exe croco.in.write > mpi_${NBPROCS}_${TEST_NAME}_$par1.log 2>&1  || { echo -e "   $msg2" | tee -a mylog.txt ; echo -e $msg1 ; exit 2 ; }
...
$MPIRUN --allow-run-as-root -np $NBPROCS ./croco_${par1}.exe croco.in.read > mpi_${NBPROCS}_${TEST_NAME}_$par1.log 2>&1  || { echo -e "   $msg2" | tee -a mylog.txt ; echo -e $msg1 ; exit 4 ; }
