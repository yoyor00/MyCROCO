...
LIST_KEY='PSOURCE FRC_BRY CLIMATOLOGY TIDES AGRIF AGRIF_2WAY BULK_FLUX MPI OPENMP REGIONAL BENGUELA_LR'
...
/bin/cp ${SOURCE_CVTK}/Config_files/cppdefs_cvtk_comp.h cppdefs_bak1.h
