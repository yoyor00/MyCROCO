...
ls ${ROOT_DIR}/STOGEN/*        > /dev/null  2>&1 && \cp -r ${ROOT_DIR}/STOGEN/* $SCRDIR

if [[ -e "namelist_stogen_ref" ]] ; then
        echo "  file namelist_stogen exists in Run directory"
else
        \cp -f ${ROOT_DIR}/STOGEN/namelist_sto* $RUNDIR
        echo "  file namelist_stogen copied from source directory"
fi
