...
if [[ -d FIC_NAMELIST ]]; then
        echo "  Mustang namelist directory FIC_NAMELIST exists"
else
        mkdir -p $RUNDIR/FIC_NAMELIST
        \cp -rf ${ROOT_DIR}/MUSTANG/NAM_CASES/*txt $RUNDIR/FIC_NAMELIST/.
