...
exec_program(${CMAKE_Fortran_COMPILER}
    ARGS -E -cpp ${tmp_check_mpi_path}
    RETURN_VALUE tmp_check_mpi_status
    OUTPUT_VARIABLE tmp_check_mpi_output
)

# extract patent dir
string(REGEX MATCH "/[^\n]+/mpif\.h" tmp_check_mpi_h_path ${tmp_check_mpi_output})
if (tmp_check_mpi_status EQUAL 0)
	get_filename_component(MPI_INCLUDE_DIR ${tmp_check_mpi_h_path} DIRECTORY)
endif()
