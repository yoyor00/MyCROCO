...
! BLOOM (base insed 17 + key_oxygen 1 = 18 bio) + MUSTANG sediment (1) = 19
! ntfix : BLOOM fixed tracers (3)
#  if defined BIOLink && defined BLOOM
      integer, parameter :: ntrc_subs = 19
      integer, parameter :: ntfix = 3
#  else
      integer, parameter :: ntrc_subs = 0
      integer, parameter :: ntfix = 0
#  endif
      integer, parameter :: ntrc_substot = ntrc_subs+ntfix
! BLOOM diagnostic array size parameters (used by ncscrum.h and diagnostics.h)
#  if defined BIOLink && defined BLOOM && defined DIAGNOSTICS_BIO
...
!
      integer, parameter :: NSAND = 0
      integer, parameter :: NMUD = 6
