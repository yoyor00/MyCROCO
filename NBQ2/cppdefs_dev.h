...
*/
#if defined RVTK_DEBUG && !defined MPI && !defined OPENMP && !defined RVTK_DEBUG_READ && !defined OPENACC
...
# undef  M3FAST_RHO
# undef  M3FAST_ZETAW
# undef  M3FAST_C3D_UVSF
# undef  M3FAST_C3D_UVFS
# undef  M3FAST_C3D_WSF
# undef  M3FAST_C3D_WFS
# undef  NBQ_GRID_SLOW
# undef  NBQ_HZCORRECT
# undef  M3FAST_AM4 
# undef  M3FAST_COUPLING2D
# undef  M3FAST_COUPLING3D
# undef  M3FAST_BOTH
...
#   define M3FAST_RHO
#   define M3FAST_ZETAW
#   define M3FAST_C3D_UVSF
#   define M3FAST_C3D_UVFS
#   define M3FAST_C3D_WSF
#   define M3FAST_C3D_WFS
