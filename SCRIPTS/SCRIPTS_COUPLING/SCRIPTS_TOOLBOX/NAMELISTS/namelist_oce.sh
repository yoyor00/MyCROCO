...
#       AGRIF, AGRIF_2WAY, 
#       BULK_FLUX, ONLINE, AROME, ARPEGE, ERA_ECMWF, FORMATTED
#       FRC_BRY, CLIMATOLOGY
...
export frc_ext='blk_ERA5' # surface forcing extension(blk_ERA5, frc_ERA5,...). If interponline=1 precise the type (ERA_ECMWF, AROME or FORMATTED,  [CFSR by default], names as cppkey name in croco)
