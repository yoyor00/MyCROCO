...
!======================================================================
!
! ms3dvar_param.h - MS3DVAR Grid Parameters
! ==========================================
!
...
!
! CPP Keys:
! - DAS          : Enable data assimilation (defined in ms3dvar_cppdefs.h)
! - DAS_IN_MBFGS : Special flag used only in ms3dvar_lbfgs.F minimizer
!
! IMPORTANT:
...
! USAGE:
! ------
! This file should be included by scale-specific param.h files
...
! Example 2: High-resolution scale (commented out)
!     parameter (LLmH=384,  MMmH=390, NnH=66)

! Example 3: Low-resolution scale (commented out)
...
!----------------------------------------------------------------------
! The L-BFGS minimizer (ms3dvar_lbfgs.F) temporarily defines DAS_IN_MBFGS
!----------------------------------------------------------------------

#if defined DAS_IN_MBFGS
! When DAS_IN_MBFGS is defined (only in ms3dvar_lbfgs.F):
...
!----------------------------------------------------------------------
! End of ms3dvar_param.h grid section.
