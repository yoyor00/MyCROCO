...
!
      ...
      integer sz_s_rad_len                ! used in ms3dvar_zeta_analysis_smooth.F and ms3dvar_zeta_s_smooth.F
      ...
      integer sts_s_rad_len                ! used ms3dvar_ts_analysis_smooth.F and ms3dvar_ts_s_smooth.F 
      ...
      PARAMETER( sz_rad=1.5)            ! used ms3dvar_zeta_smooth.F
      integer sz_rad_len               
...
! In ms3dvar_innov.h sst_mc, mc_mask, mc_ion have a 3rd dimension
