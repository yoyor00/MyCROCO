...
!======================================================================
!
! param.h - MS3DVAR FILTER Scale Grid Parameters
! =================================================
!
! This is the parameter file for the MS3DVAR FILTER scale.
! It includes the minimal ms3dvar_param.h and can add FILTER-specific settings.
!
...
!   - Add FILTER scale-specific overrides below (if any)
!
...
!----------------------------------------------------------------------
! FILTER SCALE-SPECIFIC PARAMETER OVERRIDES
!
! If the FILTER scale needs different grid dimensions or tiling
...
! If you need additional CROCO-specific parameters for your FILTER scale,
! define them here.
!----------------------------------------------------------------------
...
!----------------------------------------------------------------------
! END OF FILTER SCALE PARAMETERS
!----------------------------------------------------------------------
