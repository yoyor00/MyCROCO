/* This is include file "ms3dvar_ocean.h".
  --------------------------------------------
  FILTER scale: uses u/v velocity formulation (not psi/chi streamfunction).
  psi_das/chi_das are declared but unused - required by common COMMON code.
*/
! z-coord
