 ...
 *   - Add FILTER variant-specific overrides below
 *
...
/*=====================================================================
 * FILTER VARIANT CPP-switch : DO NOT CHANGE
 *=====================================================================*/
#define DAS_FILTER
 ...
 * Copied to  ASSIM/MS3DVAR/FILTER/Compile/cppdefs_ms3dvar.h
 *=====================================================================*/
 ...
 *
 * Customize MS3DVAR DAS_* options specifically for FILTER variant.
 * These override the defaults in cppdefs_ms3dvar.h
 *=====================================================================*/

/* No FILTER-specific overrides currently - using defaults from cppdefs_ms3dvar.h */
