...
!======================================================================
!
! param.h - MS3DVAR MS (Multi-Scale) Scale Grid Parameters
! ===========================================================
!
! This is the parameter file for the MS3DVAR MS (Multi-Scale) scale.
! It includes the minimal ms3dvar_param.h and can add MS-specific settings.
!
...
!   - Add MS scale-specific overrides below (if any)
!
...
!----------------------------------------------------------------------
! MS SCALE-SPECIFIC PARAMETER OVERRIDES
!
! If the MS scale needs different grid dimensions or tiling
...
! If you need additional CROCO-specific parameters for your MS scale,
! define them here.
!----------------------------------------------------------------------
