...
!
/*
 * cppdefs.h - MS3DVAR Low Resolution (LR) Scale Configuration
 * ==============================================================
 *
 ...
 * defined (here LR scale => DAS_LR ccp key)
 *
...
/* No LR-specific overrides currently - using defaults from ms3dvar_cppdefs.h */
