...
#include "cppdefs.h"
  ...
  CONTAINS
   ...
   REAL(KIND=rsh),DIMENSION(imin:imax, jmin:jmax, kmax),INTENT(IN) :: Hz
   ...
   ! ************************
   CALL OBSTRUCTIONS_comp_uzvz(limin, limax, ljmin, ljmax, h0, ssh, uz, vz, Hz)
...
! * FG-OBST-END
   ...
   SUBROUTINE OBSTRUCTIONS_comp_uzvz(limin, limax, ljmin, ljmax, h0, ssh, uz, vz, Hz)
   !&E---------------------------------------------------------------------
             ...
             IF(hwat.GT.obst_h0fond)THEN
               ...
               ELSE
                 ...
                 DO k=1,obst_kmax
                   ...
                   zz(k)  = obst_zc(k,i,j) + obst_dz(k,i,j)*0.5_rsh 
                 ENDDO
                 ! For k=kmax+1
                 k=kmax+1
                 zz(k)  = hwat
