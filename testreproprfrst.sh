...
export RUN_HOME=$PERFRSTHOME
export RUN_WORK=$PERFRSTWORK
export RUN_MK="mk_TESTALL_perfrst"
export RUN_GATHER="gather_recap_perfrst"

export RUN_NAME="REG"
export RUN_NAME_SCRIPT="reg_perfrst"
export RUN_MK_NAME="reg"
export RUN_NAME_CONFIGURE="CONFIGURE_REG_PERFRST"
...
/bin/sh -c '! grep -i "Restartability failed" ${RUN_NAME}_gather_recap_*_git*' > /dev/null 2>&1  
